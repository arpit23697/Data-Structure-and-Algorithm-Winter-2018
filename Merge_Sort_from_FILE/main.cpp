...
int main ()
{
    ...
    while (1)
    {
        ...
        while(1)
        {
            ...
            int counter2 = 0;
            fseek (f1 , (n1 -1) * 4 , SEEK_SET);             //setting the indices
            fseek (f2 , ((n1-1) + difference) * 4 , SEEK_SET );
            ...
            if (counter2 < difference)
            {
                do
                {
                    ...
                    fwrite (&b , 4 , 1 , file2);
                    counter2++;
                }while ((counter2 < difference) && fread (&b , 4 , 1 , f2));
            ...
            if (counter1 < difference )
            {
                do
                {
                    ...
                    fwrite ( &a, 4 , 1 , file2);
                    counter1++;
                }while ((counter1 < difference) && fread (&a , 4 , 1 , f1));
            }
